...
class GNNStack(torch.nn.Module):
    ...
    def forward(self, data):
        ...
        x = torch.transpose(original_x, 0, 1) * (1 - train_mask) + torch.transpose(train_default, 0, 1) * train_mask
...
class GraphSage(pyg_nn.MessagePassing):
    ...
    def __init__(self, in_channels, out_channels, reducer='mean',
        ...
        self.agg_lin = torch.nn.Linear(out_channels + 2 * in_channels + 1, out_channels)
